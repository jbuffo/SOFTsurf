...
salinity = [10,25,50,75,100,125,150,175,200];        % Salinity Values to Simulate Using SOFTBALL (ppt)
...
bodyname = 'Europa';                                 % Name of Body w/ Respective Gravity - for file naming 
path     = '/thayerfs/home/f0049bv';                 % Location of SOFTBALL's 'mushy-layer' directory

makeSurface(salinity,slope,C_e,beta,g,k_s,saltname,bodyname,path); % Run makeSurface for these inputs
